  ...
  ACTS:
    - ACTION: RSA_KEY_GEN
      PARAMS:
        ...
        pub_exp: [] # required: true, type: ByteArray, element_type: UnsignedByte, encoding: Hexadecimal, nullable: true, max_length: 10, unit: byte, length_param: pub_exp_len
  ...
  ACTS:
    - ACTION: RSA_KEY_SIGN
      PARAMS:
        ...
        signature: [] # required: false, type: ByteArray, element_type: UnsignedByte, encoding: Hexadecimal, nullable: true, default: [], max_length: 256, unit: byte, capacity_param: sig_len, description: Output buffer
      ...
      EXPECT:
        ...
        - signature: [] # required: false, type: ByteArray, element_type: UnsignedByte, encoding: Hexadecimal, comparison: EqualOrCondition, actual_type: ByteArray
      ARTIFACTS:
        ret_code: "" # required: false, type: String, source_type: Integer, usage: "{{ out.<alias> }}"
        sig_len: "" # required: false, type: String, source_type: UnsignedInteger, usage: "{{ out.<alias> }}"
        signature: "" # required: false, type: String, source_type: ByteArray, usage: "{{ out.<alias> }}"
```
...
- TC_ID: TC_RSA_KEY_VERIFY_TEMPLATE
  ...
  ACTS:
    - ACTION: RSA_KEY_VERIFY
      PARAMS:
        key_index: -1 # required: true, type: Integer, default: -1
        hash: [] # required: true, type: ByteArray, element_type: UnsignedByte, encoding: Hexadecimal, nullable: true, max_length: 32, unit: byte, length_param: hash_len
        ...
        signature: [] # required: true, type: ByteArray, element_type: UnsignedByte, encoding: Hexadecimal, nullable: true, max_length: 256, unit: byte, length_param: sig_len
  ...
  ACTS:
    - ACTION: RSA_KEY_ENC
      PARAMS:
        ...
        cipher: [] # required: false, type: ByteArray, element_type: UnsignedByte, encoding: Hexadecimal, nullable: true, default: [], max_length: 256, unit: byte, capacity_param: cipherlen, description: Output buffer
...
- TC_ID: TC_RSA_KEY_DEC_TEMPLATE
  ...
  ACTS:
    - ACTION: RSA_KEY_DEC
      PARAMS:
        key_index: -1 # required: true, type: Integer, default: -1
        cipher: [] # required: true, type: ByteArray, element_type: UnsignedByte, encoding: Hexadecimal, nullable: true, max_length: 256, unit: byte, length_param: cipherlen
